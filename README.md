...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`dependabot/npm_and_yarn/decode-uri-component-0.2.2`](https://github.com/Nischhalsubba/Sourcement/tree/dependabot/npm_and_yarn/decode-uri-component-0.2.2). It is generated from the files present on this branch and preserves the project-authored README below.
